...
String xPL_getFairlyUniqueIdent (void) {
  char newIdent[32];
  uint32_t localAddr;
...
xPL_ConnectType xPL_getConnectType (void) {
...
static void checkAllTimeoutHandlers (void) {
  int timeoutIndex;
  int elapsedTime;
